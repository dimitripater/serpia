...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.education'
        db.add_column(u'account_account', 'education',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Education'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.education'
        db.delete_column(u'account_account', 'education_id')
