...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Branche'
        db.create_table(u'account_branche', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('branche', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'account', ['Branche'])


    def backwards(self, orm):
        # Deleting model 'Branche'
        db.delete_table(u'account_branche')
